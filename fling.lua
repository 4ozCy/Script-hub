...
local Window = OrionLib:MakeWindow({Name = "idiot Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
--[[
...
if not Welcome then Message("Script by Denzo", "Pong kdor", 5) end
