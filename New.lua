...
main:CreateButton("Fling all", function()
...
main:CreateToggle("Touch Fling (Might Not Work Sometimes)", function(value)
if Value then
...
main:CreateButton("Crash Server (most equip btools)", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Zyneeee/Script-hub/main/Crash.lua"))
end)
