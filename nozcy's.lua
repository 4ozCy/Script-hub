...
main:CreateToggle("ESP", function(value)
    if value then
        local settings = {
        ...
        local function createEsp(player)
            ...
            drawings.displayname = newDrawing("Text")
            drawings.displayname.Size = 16
            drawings.displayname.Center = true
            drawings.displayname.Outline = true
            drawings.displayname.OutlineColor = Color3.new(0, 0, 0)
            drawings.displayname.Color = Color3.new(1, 1, 1)
        ...
        local function updateEsp(player, esp)
            ...
            if character then
                ...
                if rootPart and humanoid then
                    ...
                    esp.displayname.Visible = visible
                    ...
                    if cframe and visible then
                        ...
                        esp.displayname.Position = esp.box.Position + newVector2(width / 2, -40)
                    end
                else
